  ...
  return (
      <div className="projectLink" ref={projectRef}>
          ...
          <div className="projectLink__overlay">
            <div className={`projectLink__navigation ${isActive && "projectLink__navigation--active"}`}>
              <button type="button" onClick={() => setActiveID(projectID - 1)} className="projectLink__navigate projectLink__navigate--left">&#8249;</button>
              <button type="button" onClick={() => setActiveID(projectID + 1)} className="projectLink__navigate projectLink__navigate--right">&#8250;</button>
            </div>
